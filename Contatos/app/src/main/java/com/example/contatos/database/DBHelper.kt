...
import com.example.contatos.model.UserModel
...
class DBHelper(context: Context) : SQLiteOpenHelper (context, "database", null, 1) {
    ...
    val sql = arrayOf(
        ...
        "INSERT INTO contact (name, address, email, phone, imageId) VALUES ('Gabriel','address Gabriel','gabriel_email@gmail.com', 40028922, -1)",
        "INSERT INTO contact (name, address, email, phone, imageId) VALUES ('Yann','address Yann','yann_email@gmail.com', 40028923, -1)",
    )
